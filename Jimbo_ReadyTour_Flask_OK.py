...
#== for first time ===
if os.path.exists('Jimbo_readyTour_cookies.json'):
    ''
else:  # file nist
...
def delete_cookies_periodically():
    while True:
        ...
        if os.path.exists('Jimbo_readyTour_cookies.json'):
            os.remove('Jimbo_readyTour_cookies.json')
...
def get_booking_tours(source,target,start_date, night_count,adults):
    try:
        ...
        url = f"https://www.jimbo.ir/trip/?i={start_date}&o={end_date}&r=1&n=&d={target_tour}&or={source_tour}&a={adults}&c=0#/"
...
def load_cookies():
    if os.path.exists('Jimbo_readyTour_cookies.json'):
        with open('Jimbo_readyTour_cookies.json', 'r') as json_file:
            return json.load(json_file)
    else:
        print(' Jimbo_readyTour_cookies.json not exists !!!!!! ')
        # return renew_and_save_cookies()

# def renew_and_save_cookies():
#     cookies = get_authorization()
#     cookies_dict = {cookie.name: cookie.value for cookie in cookies}
#     with open('Jimbo_readyTour_cookies.json', 'w') as json_file:
