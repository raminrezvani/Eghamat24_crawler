...
def run_services():
    ...
    services = [
        ("Booking_Hotel_flask_OK.py", 5001),
        # ("Jimbo_Hotel_flask_OK.py", 5002),
        ("Crawl_alaedin_Rooms_Flask_OK.py", 5003),
        ("Crawl_Snapp_SignIn_OK.py", 5004),
        ("Eghamat24_Service_OK.py", 8022)
    ]
